...
void ShapeRegressor::Train(const vector<Mat_<uchar> > & images,
    ...
    Mat_<double> mean_rotation(2, 2, CV_64FC1);
    mean_rotation(0, 0) = cos(30 * 3.14159265 / 180);
    mean_rotation(0, 1) = sin(30 * 3.14159265 / 180);
    mean_rotation(1, 0) = -sin(30 * 3.14159265 / 180);
    mean_rotation(1, 1) = cos(30 * 3.14159265 / 180);
    mean_shape_ = mean_shape_ * mean_rotation;
